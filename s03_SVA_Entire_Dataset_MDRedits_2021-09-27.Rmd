...
write.csv(SVs, "SVs_Orthogroup_RNAseq_9-27-21.csv")
rownames(SVs_no_fam) <- colnames(mdata)
write.csv(SVs_no_fam, "SVs_no_fam_Orthogroup_RNAseq_9-27-21.csv")
rownames(SVs_no_tis) <- colnames(mdata)
write.csv(SVs_no_tis, "SVs_no_tissue_Orthogroup_RNAseq_9-27-21.csv")
rownames(SVs_no_fam_tis) <- colnames(mdata)
write.csv(SVs_no_fam_tis, "SVs_no_family_tissue_Orthogroup_RNAseq_9-27-21.csv")
```
...
write.csv(clean_data_svs, "clean_Orthogroup_RNAseq_onlySVsCorrected_9-27-21.csv", quote = F)
write.csv(clean_data_noFam, "clean_Orthogroup_RNAseq_FamilyCorrected_9-27-21.csv", quote = F)
write.csv(clean_data_noTis, "clean_Orthogroup_RNAseq_TissueCorrected_9-27-21.csv", quote = F)
write.csv(clean_data_noFamTis, "clean_Orthogroup_RNAseq_FamilyAndTissueCorrected_9-27-21.csv", quote = F)
